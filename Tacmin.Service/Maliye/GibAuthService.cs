...
namespace Tacmin.Service
{
    public class GibAuthService
    {
        ...
        public string IvdGirisYap(string userId, string password)
        {
            var captchaSayac = 0;
            var captcha = "";
            var imageID = "";
        ...
        public void IvdCikisYap(string token)
        {
            ...
            GibRequestService.PostJsonRequest("https://ivd.gib.gov.tr/tvd_server/dispatch", data);
        }
