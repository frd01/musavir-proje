...
namespace DataIslemler.Tebligat.VergiDenetim
{
    public class ListeIslem
    {
        ...
        {
            var liste = new List<VergiDenetimMlyListeModel>();
        ...
        public List<TebligatDataListModel> GetTebligatListesi(string durum = "Okunmadı",DateTime? tarih=null)
        {
            ...
            var data_list = data.Tebligat_Vergi_Denetims.ToList();
        ...
        private int dataKayitKontrol(VergiDenetimMlyListeModel item)
        {
        ...
        private int WhasappKontrol(int? tebligatId)
        {
            ...
            var liste = data_gonderi_listesi.Where(x => x.EvrakId == tebligatId && x.EvrakTur == (int)EvrakTurEnum.TEBLIGAT_VERGI_DENETIM_BASKANLIGI).ToList();
...
&& m.EvrakTur == (int)EvrakTurEnum.TEBLIGAT_VERGI_DENETIM_BASKANLIGI
        ...
        {
            var liste = data.TebligatDosyalars.Where(x => x.TebligatId == tebligatId && x.Tur == "ek" && x.ModulId == (int)TebligatModulEnums.VERGI_DENETIM).ToList();
